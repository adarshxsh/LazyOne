...
class RewardLedger(models.Model):
    TRANSACTION_TYPES = (
        ...
        ('taker_collateral_deposit', 'Taker Collateral Deposit Staked'),
        ('taker_collateral_refund', 'Taker Collateral Refunded'),
        ('taker_collateral_slashed', 'Taker Collateral Slashed'),
    )
