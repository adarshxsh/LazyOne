...
class JuryAssignment(models.Model):
    ...
    stake_status = models.CharField(max_length=20, choices=STAKE_STATUS_CHOICES, default='locked')
    ...
    def __str__(self):
        return f"Jury assignment: {self.juror.username} for dispute {self.dispute.id}"
