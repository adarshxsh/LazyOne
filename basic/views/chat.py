...
def chat_view(request, conversation_id):
    ...
    is_disputed = bool(conversation.task and conversation.task.status == 'disputed')

    if not is_participant and not is_disputed:
        ...
        return redirect('home')
    logger.info("Step 2: Authorization verified.")

    is_readonly = not is_participant
    ...
    context = {'conversation': conversation, 'messages': messages_list, 'is_readonly': is_readonly}
