...
def complete_task(request, task_id):
    ...
    if task.status == 'disputed':
        messages.error(request, "Unilateral task completion is forbidden while a task is in disputed status.")
        return HttpResponseForbidden("Unilateral task completion is forbidden while a task is in disputed status.")
