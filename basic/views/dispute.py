        ...
        with transaction.atomic():
            ...
            if doer_evidences and not poster_evidences:
                ...
                dispute.refund_deposit(
                    reason_description=f"Security deposit bond refunded for expired dispute won on task: '{task.title}'"
                )
                ...
                dispute.forfeit_deposit(
                    ...
                    reason_description=f"Security deposit bond forfeited for expired dispute on task: '{task.title}'"
                )
    ...
    if request.method == 'POST':
        ...
        with transaction.atomic():
            ...
            if hasattr(task, 'dispute'):
                ...
                dispute.expires_at = now + timedelta(hours=48)
                dispute.save()
            else:
