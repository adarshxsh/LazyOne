...
def raise_dispute(request, task_id):
    ...
    if hasattr(task, 'dispute') and task.dispute.status in ['evidence_pending', 'under_review']:
    ...
    if request.method == 'POST':
        ...
        messages.success(request, f"Dispute raised successfully. Status set to Evidence Pending. {deposit_amount} points held as deposit bond.")
