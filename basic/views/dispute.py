...
def raise_dispute(request, task_id):
    ...
    if task.active_dispute:
        return redirect('dispute_detail', dispute_id=task.active_dispute.id)
    if (task.posted_by != request.user and task.taken_by != request.user) or task.status != 'in_progress':
