...
def _resolve_dispute(dispute, winning_party):
    ...
    # Deposit bond escrow handling
    if dispute.raised_by == dispute.winner:
        dispute.refund_deposit()
    elif dispute.winner:
        dispute.forfeit_deposit(beneficiary=dispute.winner)
...
def raise_dispute(request, task_id):
    ...
    if request.method == 'POST':
        ...
        messages.success(request, f"Dispute raised successfully. {deposit_amount} points held as deposit bond. Neutral peer jury has been selected.")
