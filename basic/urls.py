...
from .views.dispute import dispute_detail_view, withdraw_dispute, raise_dispute, transition_dispute
...
urlpatterns = [
    ...
    path('dispute/<int:dispute_id>/transition/', transition_dispute, name='transition_dispute'),
