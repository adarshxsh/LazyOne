...
from .views.dispute import dispute_detail_view, withdraw_dispute, raise_dispute, post_dispute_counter_bond, cast_juror_vote
...
urlpatterns = [
    ...
    path('dispute/counter-bond/<int:dispute_id>/', post_dispute_counter_bond, name='post_dispute_counter_bond'),
    path('dispute/vote/<int:dispute_id>/', cast_juror_vote, name='cast_juror_vote'),
