...
from .views.dispute import (
    ...
    admin_dispute_dashboard, admin_override_dispute
)
...
urlpatterns = [
    ...
    path('admin/disputes/', admin_dispute_dashboard, name='admin_dispute_dashboard'),
    path('admin/disputes/override/<int:dispute_id>/', admin_override_dispute, name='admin_override_dispute'),
    path('admin/dispute/override/<int:dispute_id>/', admin_override_dispute, name='admin_override_dispute_alias'),
