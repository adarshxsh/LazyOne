...
from .views.dispute import dispute_detail_view, withdraw_dispute, raise_dispute, update_dispute_status
...
urlpatterns = [
    ...
    path('dispute/status/<int:dispute_id>/', update_dispute_status, name='update_dispute_status'),
