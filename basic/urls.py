...
from .views.dispute import dispute_detail_view, withdraw_dispute, raise_dispute, cast_juror_vote, jury_portal_view
...
urlpatterns = [
    ...
    path('jury/', jury_portal_view, name='jury_portal'),
