...
from .views.dispute import (
    ...
    submit_dispute_evidence, auto_resolve_disputes
)
...
urlpatterns = [
    ...
    path('dispute/<int:dispute_id>/evidence/', submit_dispute_evidence, name='submit_dispute_evidence'),
    path('dispute/withdraw/<int:dispute_id>/', withdraw_dispute, name='withdraw_dispute'),
    path('api/disputes/auto-resolve/', auto_resolve_disputes, name='auto_resolve_disputes'),
