...
from .views.dispute import dispute_detail_view, withdraw_dispute, raise_dispute, vote_dispute, settle_dispute
...
urlpatterns = [
    ...
    path('dispute/<int:dispute_id>/vote/', vote_dispute, name='vote_dispute'),
    path('dispute/<int:dispute_id>/settle/', settle_dispute, name='settle_dispute'),
