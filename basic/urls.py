...
from .views.dispute import dispute_detail_view, withdraw_dispute, raise_dispute, submit_evidence, cast_vote
...
urlpatterns = [
    ...
    path('dispute/submit_evidence/<int:dispute_id>/', submit_evidence, name='submit_evidence'),
    path('dispute/cast_vote/<int:dispute_id>/', cast_vote, name='cast_vote'),
