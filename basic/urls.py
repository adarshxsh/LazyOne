...
from .views.dispute import dispute_detail_view, withdraw_dispute, raise_dispute, cast_jury_vote
...
urlpatterns = [
    ...
    path('dispute/<int:dispute_id>/vote/', cast_jury_vote, name='cast_jury_vote'),
