...
from .views.dispute import dispute_detail_view, withdraw_dispute, raise_dispute, submit_dispute_vote_view
...
urlpatterns = [
    ...
    path('dispute/vote/<int:dispute_id>/', submit_dispute_vote_view, name='submit_dispute_vote'),
