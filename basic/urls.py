...
from .views.dispute import dispute_detail_view, withdraw_dispute, raise_dispute, file_appeal, cast_juror_vote
...
urlpatterns = [
    ...
    path('dispute/appeal/file/<int:dispute_id>/', file_appeal, name='file_appeal'),
    path('dispute/appeal/vote/<int:appeal_id>/', cast_juror_vote, name='cast_juror_vote'),
