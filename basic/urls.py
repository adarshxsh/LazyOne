...
from .views.dispute import dispute_detail_view, withdraw_dispute, raise_dispute, add_dispute_evidence
...
urlpatterns = [
    ...
    path('dispute/<int:dispute_id>/evidence/add/', add_dispute_evidence, name='add_dispute_evidence'),
