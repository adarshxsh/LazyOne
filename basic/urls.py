...
from .views.dispute import dispute_detail_view, withdraw_dispute, raise_dispute, add_evidence
...
urlpatterns = [
    ...
    path('dispute/<int:dispute_id>/evidence/', add_evidence, name='add_evidence'),
