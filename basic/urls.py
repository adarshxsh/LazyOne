...
from .views.dispute import (
    ...
    commit_vote, reveal_vote, dispute_status_api
)
...
urlpatterns = [
    ...
    path('dispute/<int:dispute_id>/commit/', commit_vote, name='commit_dispute_vote'),
    path('dispute/<int:dispute_id>/reveal/', reveal_vote, name='reveal_dispute_vote'),
    path('dispute/<int:dispute_id>/status/', dispute_status_api, name='dispute_status_api'),
