...
from .views.dispute import dispute_detail_view, withdraw_dispute, raise_dispute, vote_dispute, resolve_dispute_view
...
urlpatterns = [
    ...
    path('dispute/resolve/<int:dispute_id>/', resolve_dispute_view, name='resolve_dispute'),
