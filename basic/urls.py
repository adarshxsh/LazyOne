...
from .views.dispute import (
    ...
    dispute_arbitrate, submit_appeal, resolve_appeal
)
...
urlpatterns = [
    ...
    path('dispute/arbitrate/<int:dispute_id>/', dispute_arbitrate, name='dispute_arbitrate'),
    path('dispute/appeal/<int:dispute_id>/', submit_appeal, name='submit_appeal'),
    path('dispute/appeal/resolve/<int:dispute_id>/', resolve_appeal, name='resolve_appeal'),
