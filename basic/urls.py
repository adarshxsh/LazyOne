...
from .views.dispute import dispute_detail_view, withdraw_dispute, raise_dispute, submit_dispute_vote, appeal_dispute
...
urlpatterns = [
    ...
    path('dispute/<int:dispute_id>/vote/', submit_dispute_vote, name='submit_dispute_vote'),
    path('dispute/<int:dispute_id>/appeal/', appeal_dispute, name='appeal_dispute'),
