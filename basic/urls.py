...
from .views.dispute import (
    ...
    counter_stake_dispute, vote_dispute, settle_dispute_view
)
...
urlpatterns = [
    ...
    path('dispute/counter_stake/<int:dispute_id>/', counter_stake_dispute, name='counter_stake_dispute'),
    path('dispute/vote/<int:dispute_id>/', vote_dispute, name='vote_dispute'),
    path('dispute/settle/<int:dispute_id>/', settle_dispute_view, name='settle_dispute'),
