...
from .views.dispute import dispute_detail_view, withdraw_dispute, raise_dispute, submit_commitment, reveal_vote, transition_phase
...
urlpatterns = [
    ...
    path('dispute/<int:dispute_id>/commit/', submit_commitment, name='submit_commitment'),
    path('dispute/<int:dispute_id>/reveal/', reveal_vote, name='reveal_vote'),
    path('dispute/<int:dispute_id>/transition/', transition_phase, name='transition_phase'),
