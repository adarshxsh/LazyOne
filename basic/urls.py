...
from .views.dispute import dispute_detail_view, withdraw_dispute, raise_dispute, upload_dispute_evidence
...
urlpatterns = [
    ...
    path('dispute/<int:dispute_id>/upload-evidence/', upload_dispute_evidence, name='upload_dispute_evidence'),
    path('dispute/<int:dispute_id>/upload/', upload_dispute_evidence, name='upload_dispute_evidence_alt'),
