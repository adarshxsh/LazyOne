...
from .views.dispute import (
    ...
    cast_dispute_vote, file_dispute_appeal, staff_resolve_dispute
)
...
urlpatterns = [
    ...
    path('dispute/<int:dispute_id>/vote/', cast_dispute_vote, name='cast_dispute_vote'),
    path('dispute/<int:dispute_id>/appeal/', file_dispute_appeal, name='file_dispute_appeal'),
    path('dispute/<int:dispute_id>/staff-resolve/', staff_resolve_dispute, name='staff_resolve_dispute'),
