...
from .views.dispute import dispute_detail_view, withdraw_dispute, raise_dispute, submit_jury_vote
...
urlpatterns = [
    ...
    path('dispute/<int:dispute_id>/jury/', dispute_detail_view, name='dispute_jury_view'),
