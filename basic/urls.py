...
from .views.dispute import dispute_detail_view, withdraw_dispute, raise_dispute, vote_dispute
...
urlpatterns = [
    ...
    path('dispute/vote/<int:dispute_id>/', vote_dispute, name='vote_dispute_alt'),
