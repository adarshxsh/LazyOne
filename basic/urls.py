...
from .views.dispute import dispute_detail_view, withdraw_dispute, raise_dispute, file_appeal, cast_jury_vote
...
urlpatterns = [
    ...
    path('appeal/<int:appeal_id>/vote/', cast_jury_vote, name='cast_jury_vote'),
