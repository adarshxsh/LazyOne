...
from .views.dispute import dispute_detail_view, withdraw_dispute, raise_dispute, staff_resolve_dispute
...
urlpatterns = [
    ...
    path('dispute/staff/resolve/<int:dispute_id>/', staff_resolve_dispute, name='staff_resolve_dispute'),
