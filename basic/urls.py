...
from .views.dispute import dispute_detail_view, withdraw_dispute, raise_dispute, submit_juror_vote
...
urlpatterns = [
    ...
    path('dispute/<int:dispute_id>/vote/', submit_juror_vote, name='submit_juror_vote'),
