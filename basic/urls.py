...
from .views.dispute import (
    ...
    admin_dispute_queue, resolve_dispute, submit_appeal, resolve_appeal
)
...
urlpatterns = [
    ...
    # Dispute URLs
    path('disputes/admin/', admin_dispute_queue, name='admin_dispute_queue'),
    ...
    path('dispute/<int:dispute_id>/appeal/resolve/', resolve_appeal, name='resolve_appeal'),
