...
from .views.dispute import dispute_detail_view, withdraw_dispute, raise_dispute, post_dispute_message
...
urlpatterns = [
    ...
    path('dispute/<int:dispute_id>/message/', post_dispute_message, name='post_dispute_message'),
