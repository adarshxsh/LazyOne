...
from .views.dispute import (
    ...
    escalate_to_jury, cast_jury_vote, jury_portal_view
)
...
urlpatterns = [
    ...
    path('dispute/escalate/<int:dispute_id>/', escalate_to_jury, name='escalate_to_jury'),
    path('dispute/vote/<int:dispute_id>/', cast_jury_vote, name='cast_jury_vote'),
    path('disputes/jury/', jury_portal_view, name='jury_portal'),
