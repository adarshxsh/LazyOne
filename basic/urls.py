...
from .views.dispute import dispute_detail_view, withdraw_dispute, raise_dispute, settle_partial_dispute
...
urlpatterns = [
    ...
    path('dispute/<int:dispute_id>/settle-partial/', settle_partial_dispute, name='settle_partial_dispute'),
