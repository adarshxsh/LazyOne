...
from .views.dispute import dispute_detail_view, withdraw_dispute, raise_dispute, staff_dispute_list, staff_resolve_dispute
...
urlpatterns = [
    ...
    path('staff/disputes/', staff_dispute_list, name='staff_disputes'),
    path('staff/dispute/<int:dispute_id>/resolve/', staff_resolve_dispute, name='staff_resolve_dispute'),
