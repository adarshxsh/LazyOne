...
from .views.dispute import (
    ...
    vote_dispute, appeal_dispute, resolve_appeal
)
...
urlpatterns = [
    ...
    path('dispute/appeal/<int:dispute_id>/', appeal_dispute, name='appeal_dispute'),
    path('dispute/resolve-appeal/<int:dispute_id>/', resolve_appeal, name='resolve_appeal'),
