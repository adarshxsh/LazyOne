...
from .views.dispute import dispute_detail_view, withdraw_dispute, raise_dispute, cast_dispute_vote, file_appeal, finalize_dispute
...
urlpatterns = [
    ...
    path('dispute/vote/<int:dispute_id>/', cast_dispute_vote, name='cast_dispute_vote'),
    path('dispute/appeal/<int:dispute_id>/', file_appeal, name='file_appeal'),
    path('dispute/finalize/<int:dispute_id>/', finalize_dispute, name='finalize_dispute'),
