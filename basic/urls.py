...
from .views.dispute import (
    ...
    submit_evidence, submit_vote, submit_appeal, advance_dispute_phase_view
)
...
urlpatterns = [
    ...
    path('dispute/<int:dispute_id>/evidence/', submit_evidence, name='submit_evidence'),
    path('dispute/<int:dispute_id>/vote/', submit_vote, name='submit_vote'),
    path('dispute/<int:dispute_id>/appeal/', submit_appeal, name='submit_appeal'),
    path('dispute/<int:dispute_id>/advance/', advance_dispute_phase_view, name='advance_dispute_phase'),
