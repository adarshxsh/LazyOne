...
from .views.jury import jury_dashboard_view, jury_dispute_detail_view, submit_jury_vote_view
...
urlpatterns = [
    ...
    # Jury URLs
    path('jury/', jury_dashboard_view, name='jury_dashboard'),
    path('jury/dispute/<int:dispute_id>/', jury_dispute_detail_view, name='jury_dispute_detail'),
    path('jury/dispute/<int:dispute_id>/vote/', submit_jury_vote_view, name='submit_jury_vote'),
