...
from .views.dispute import dispute_detail_view, withdraw_dispute, raise_dispute, vote_on_dispute
...
urlpatterns = [
    ...
    path('dispute/<int:dispute_id>/vote/', vote_on_dispute, name='vote_on_dispute'),
