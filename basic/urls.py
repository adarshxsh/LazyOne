...
from .views.dispute import (
    ...
    submit_vote_commitment, submit_vote_reveal
)
...
urlpatterns = [
    ...
    path('dispute/<int:dispute_id>/commit/', submit_vote_commitment, name='submit_vote_commitment'),
    path('dispute/<int:dispute_id>/reveal/', submit_vote_reveal, name='submit_vote_reveal'),
