...
from .views.dispute import dispute_detail_view, withdraw_dispute, raise_dispute, submit_dispute_vote
...
urlpatterns = [
    ...
    path('dispute/vote/<int:dispute_id>/', submit_dispute_vote, name='submit_dispute_vote'),
