...
from .views.dispute import (
    ...
    admin_disputes_view, admin_dispute_override_view
)
...
urlpatterns = [
    ...
    path('admin/disputes/', admin_disputes_view, name='admin_disputes'),
    path('disputes/manage/', admin_disputes_view, name='disputes_manage'),
    path('admin/disputes/<int:dispute_id>/override/', admin_dispute_override_view, name='admin_dispute_override'),
