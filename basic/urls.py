...
from .views.dispute import dispute_detail_view, withdraw_dispute, raise_dispute, resolve_dispute, settle_dispute
...
urlpatterns = [
    ...
    path('dispute/settle/<int:dispute_id>/', settle_dispute, name='settle_dispute'),
