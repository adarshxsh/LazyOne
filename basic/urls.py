...
from .views.dispute import dispute_detail_view, withdraw_dispute, raise_dispute, cast_dispute_vote
...
urlpatterns = [
    ...
    path('dispute/<int:dispute_id>/vote/', cast_dispute_vote, name='vote_dispute'),
