...
from .views.dispute import dispute_detail_view, withdraw_dispute, raise_dispute, cast_juror_vote, file_dispute_appeal
...
urlpatterns = [
    ...
    path('dispute/appeal/<int:dispute_id>/', file_dispute_appeal, name='file_dispute_appeal'),
