...
from .views.dispute import dispute_detail_view, withdraw_dispute, raise_dispute, cron_resolve_expired_disputes
...
urlpatterns = [
    ...
    path('api/cron/resolve-expired-disputes/', cron_resolve_expired_disputes, name='cron_resolve_expired_disputes'),
