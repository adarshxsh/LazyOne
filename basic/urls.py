...
urlpatterns = [
    ...
    path('dispute/<int:dispute_id>/upload/', upload_dispute_evidence, name='upload_dispute_evidence'),
    path('dispute/<int:dispute_id>/upload_evidence/', upload_dispute_evidence, name='upload_evidence'),
