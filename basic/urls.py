...
from .views.dispute import dispute_detail_view, withdraw_dispute, raise_dispute, submit_evidence
...
urlpatterns = [
    ...
    path('dispute/<int:dispute_id>/submit_evidence/', submit_evidence, name='submit_evidence'),
