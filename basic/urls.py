...
from .views.dispute import (
    ...
    staff_disputes_list, arbitrate_dispute, submit_appeal, review_appeal
)
...
urlpatterns = [
    ...
    path('staff/disputes/', staff_disputes_list, name='staff_disputes_list'),
    ...
    path('dispute/appeal/review/<int:dispute_id>/', review_appeal, name='review_appeal'),
