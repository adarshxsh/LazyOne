...
from .views.dispute import dispute_detail_view, withdraw_dispute, raise_dispute, upload_dispute_evidence, download_dispute_evidence
...
urlpatterns = [
    ...
    path('dispute/<int:dispute_id>/upload_evidence/', upload_dispute_evidence, name='upload_dispute_evidence'),
    path('dispute/evidence/<int:evidence_id>/download/', download_dispute_evidence, name='download_dispute_evidence'),
