...
from .views.dispute import dispute_detail_view, withdraw_dispute, raise_dispute, partial_settle_dispute
...
urlpatterns = [
    ...
    path('dispute/partial_settle/<int:dispute_id>/', partial_settle_dispute, name='partial_settle_dispute'),
