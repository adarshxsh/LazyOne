...
from .views.dispute import (
    ...
    dispute_adjudicate_view, submit_jury_vote, my_jury_cases_view
)
...
urlpatterns = [
    ...
    path('dispute/<int:dispute_id>/adjudicate/', dispute_adjudicate_view, name='dispute_adjudicate'),
    path('dispute/<int:dispute_id>/vote/', submit_jury_vote, name='submit_jury_vote'),
    path('jury/my-cases/', my_jury_cases_view, name='my_jury_cases'),
