...
from .views.dispute import dispute_detail_view, withdraw_dispute, raise_dispute, upload_evidence
...
urlpatterns = [
    ...
    path('dispute/evidence/upload/<int:dispute_id>/', upload_evidence, name='upload_evidence'),
    path('dispute/<int:dispute_id>/evidence/upload/', upload_evidence, name='upload_evidence_alt'),
