...
from .views.dispute import (
    ...
    submit_evidence, advance_to_voting, cast_vote
)
...
urlpatterns = [
    ...
    path('dispute/evidence/<int:dispute_id>/', submit_evidence, name='submit_evidence'),
    path('dispute/advance_voting/<int:dispute_id>/', advance_to_voting, name='advance_to_voting'),
    path('dispute/vote/<int:dispute_id>/', cast_vote, name='cast_vote'),
