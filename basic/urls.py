...
from .views.dispute import (
    ...
    upload_dispute_attachment, download_dispute_attachment
)
...
urlpatterns = [
    ...
    path('dispute/<int:dispute_id>/upload-attachment/', upload_dispute_attachment, name='upload_dispute_attachment'),
    path('dispute/attachment/<int:attachment_id>/download/', download_dispute_attachment, name='download_dispute_attachment'),
