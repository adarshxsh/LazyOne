...
class BilateralDisputeTests(TestCase):
    def setUp(self):
        ...
        self.other_profile.rewards = 1000
    ...
    def test_withdraw_dispute_by_poster(self):
        dispute = Dispute.objects.create(task=self.task, raised_by=self.poster, reason='Issue raised', deposit_amount=50, escrow_status='held')
    ...
    def test_withdraw_dispute_by_taker(self):
        dispute = Dispute.objects.create(task=self.task, raised_by=self.taker, reason='Issue raised', deposit_amount=50, escrow_status='held')
        self.task.status = 'disputed'
        self.task.save()
